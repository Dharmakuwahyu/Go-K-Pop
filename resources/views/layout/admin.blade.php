        ...
        <aside class="admin-sidebar" id="admin-sidebar">
            <div class="sidebar-header">
                ...
                <div class="sidebar-brand">
                    ...
                    <span class="sidebar-brand-text">GO 
                        <span class="k">K-POP</span> 
                        <span class="sub">Admin</span>
                    </span>
                </div>
            </div>
            <nav class="sidebar-nav">
                <button class="sidebar-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" 
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.campaign') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.campaign') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.payment') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.payment') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.order') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.order') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.sorting') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.sorting') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.shipment') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.shipment') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button class="sidebar-item {{ request()->routeIs('admin.setting') ? 'active' : '' }}" 
                    onclick="location.href='{{ route('admin.setting') }}'">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
